...
const survey = [
    {
        questionType: 'Info',
        questionText: 'Personalize your experience on Food Hacker! Tap next to continue.'
    },
    // {
    ...
    },
{
        questionType: 'MultipleSelectionGroup',
        questionText:
            'Do you have any of these diets?',
        questionId: 'foodDiets',
        questionSettings: {
            maxMultiSelect: 9,
            minMultiSelect: 1,
        },
    ...
    },
    {
        ...
        options: [
            {
                optionText: 'Learn New Skills',
                value: 'Learn New Skills'
            },
            {
                optionText: 'Try New Cuisines',
                value: 'Try New Cuisines'
            },
            {
                optionText: 'Save Time',
                value: 'Save Time'
            },
            {
    ...
    {
        questionType: 'Info',
        questionText: 'That is all for Food Hacker, tap finish to see your results!'
    },
];
...
export default class SurveyScreen extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = { backgroundColor: GREY, answersSoFar: '' };
    }
